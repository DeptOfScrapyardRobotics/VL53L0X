...
namespace DeptOfScrapyardRobotics\Sensors\VL53Lxx\Runners\Sketches\Demos\VL53L1X\Assets;
...
class RangeHud extends UIComponent
{
    ...
    public function __construct(int $minMm = 40, int $maxMm = 4000)
    {
        parent::__construct('vl53l1x-range-hud');
